    ...
    return (
        ...
        >
            <div className="flex-1 overflow-hidden">
                ...
                <div className="h-full py-6 px-4 sm:py-10 sm:px-8 lg:py-16 lg:px-16 xl:py-24 xl:px-32 bg-white dark:bg-[#1f232b] text-gray-900 dark:text-gray-200 transition-colors duration-200">
                    <div className="w-full max-w-7xl mx-auto h-full">
