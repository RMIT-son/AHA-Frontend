...
export default function ChatWindow({
    ...
    useEffect(() => {
        ...
        if (botMessages.length > 0) {
            ...
            // Check if this is a new bot message
    ...
    const renderedMessages = useMemo(() => {
        return messages.map((message, index) => {
            ...
            const shouldStream = isBotMessage && 
                                 message.shouldStream && // Check the shouldStream flag from message handler
                                 !message.streamingComplete && // Only if not already marked as complete
                                 message.content && // Has content
                                 message.content.trim().length > 0; // Content is not empty
